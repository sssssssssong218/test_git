...
<!-- 게시판 검색 시작 { -->
    <fieldset id="bo_sch" style="">
        ...
        <input type="text" name="stx" value="" required="" id="stx" class="frm_input required" size="15" maxlength="20" "="" placeholder="검색어를 입력해주세요" style="">
...
<!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <colgroup><col class="colnum"><col class="colsec"><col class="coltit"><col class="colname" style="width:120px"><col class="coldate" style="width:120px">
        </colgroup>
        <thead>
        <tr>
            <th scope="col">번호</th>
            ...
            <th scope="col" style="width:250px">등록일<a href="/bbs/board.php?bo_table=5010&amp;sop=and&amp;sst=wr_datetime&amp;sod=desc&amp;sfl=&amp;stx=&amp;page=1" style=""></a></th>
            <th scope="col" style="width:250px">조회 수<a href="/bbs/board.php?bo_table=5010&amp;sop=and&amp;sst=wr_hit&amp;sod=desc&amp;sfl=&amp;stx=&amp;page=1" style=""></a></th>
        </tr>
        </thead>
        <tbody style="text-align:center">
            ...
            <td class="td_num">
            <strong>자주 찾는 질문</strong></td>
            <td class="td_subject" style="">
           <a href="https://www.ncyok.or.kr:443/bbs/board.php?bo_table=5010&amp;wr_id=2745" style="">
                    ♠「K-청소년 디지털 역량 강화 캠프」고등부 프로그램 공지 ♠</a>
			</td>
            <td class="td_datetime" style="">2023-10-10</td>
            <td class="td_num" style="">216</td>
            </tr>
